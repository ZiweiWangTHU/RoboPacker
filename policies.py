...
class Coordinator(object):
    ...
    def __init__(self, save_dir, ckpt_file, feat_size=6, buffer_size=200, batch_size=20): # nontarget
    ...
    def predict(self, X):
        ...
        # print('*** coor prediction', net_outputs.view(-1, 3).cpu().detach().numpy())
        return np.argmax(net_outputs.view(-1, 3).cpu().detach().numpy(), axis=1)
