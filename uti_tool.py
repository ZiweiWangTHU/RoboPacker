...
def depth_2_mesh_all(depth,K):
    ...
    mesh=getFiles_cate(depth, [r1,r2,c1,c2], K, step=1, enl=0)
...
# 'cracker_box': [35, 82, 107],
def var_2_norm(pc, ex, ey, ez, c=''):
    unit = {
        'large_clamp': [120, 171, 39],
        'pudding_box': [138, 129, 39],
        'potted_meat_can': [82, 48, 67],
        'pitcher_base': [60, 58, 97],
        'laptop': [346, 200, 335],
        'mug': [93, 74, 65],
        'cracker_box': [213, 164, 71],
        'sugar_box': [25, 47, 88],
        'mustard_bottle': [48, 33, 96],
        'power_drill': [92, 94, 29],
        'mug_deformed': [70, 86, 60],
        '02876657': [324/4, 874/4, 321/4],
        '02880940': [675/4, 271/4, 675/4],
        '02942699': [464/4, 487/4, 702/4],
        '02946921': [450/4, 753/4, 460/4],
        '03642806': [581/4, 445/4, 672/4],
        '03797390': [670/4, 540/4, 497/4]
    }

    unitx, unity, unitz = unit[c]

    OR, lx, ly, lz, miny, maxy = get_3D_corner_def(pc)  # lx、ly、lz指的是标准模型点云pc在xyz三个轴上的跨度（最大值-最小值）
